...
function App() {
  ...
  if (page === "trek") {
    const trekDestinations = destinations.filter((destination) => destination.destinationType === 'trek');

    return (
      <main className="site-shell">
        <DestinationPage
          activePage="trek"
          key="trek-destinations"
          destinations={trekDestinations}
          destinationsLoading={destinationsLoading}
          images={destinationImages}
          onNavigate={navigateTo}
          onViewDetails={openTripDetail}
          title="Trek destinations for mountain journeys"
  ...
  if (page === "gallery") {
    return (
      <main className="site-shell">
        <GalleryPage galleryItems={galleryItems} onNavigate={navigateTo} />
        <PlaneAnimation active={true} scrollReveal={false} />
        <WhatsAppButton />
      </main>
    );
